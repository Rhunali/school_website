...
<head>
  ...
  <title>Junior KG Program by Kids Nation</title>

  <meta name="description" content="Enroll in Kids Nation Junior KG program: fostering a love for learning Where your child's potential is limitless ">
  <meta name="keywords" content="
junior kg, jr kg, junior kindergarten, curriculumn, preschool
 ">
  <meta name="robots" content="index, follow" />
  <link rel="canonical" href="junior-kg.php" />
  ...
  <section class="page-header bg_img" data-background="static/front/images/banner/page-header.png">
    <div class="container">
      <div class="page-header-content">
        <h1 class="title">Curriculum Junior KG</h1>

      </div>
    </div>
  </section>
  <section class="about-section pt-50 pb-50 bg-light">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-md-8 col-md-offset-2 col-12">
          <h4>THEMES</h4>
          <ul>
            <li>10 broad themes & 40 sub themes have been introduced</li>
          </ul>
          <h4>LANGUAGE</h4>
          <ul>
            <li> Letters: Identification & Writing of capital letters from A to Z & small letter a to z</li>
            <li>Answering questions orally on stories.</li>
            <li>Writing: Patterns for print writing</li>
          </ul>
          <h4>MATH</h4>
          <ul>
            <li>More & less, Biggest & smallest, Heavy and light</li>
            <li>Number Value: 0 to 100, Number names one to
              twenty (tracing & writing)</li>
            <li>Shapes –Semi-circle, crescent, pentagon</li>
            <li>Missing numbers (1-20), backwards counting
              (20-1) skip counting by 5 & 10</li>
          </ul>
          <h4>Academic Calendar</h4>
          <a href="#" data-toggle="modal" data-target="#myModal"><img src="static\front\images\client\List-of-Celebrations-Kids-Nation-1.webp" alt="Image" /></a>
        </div>
      </div> <!-- /.row -->
    </div> <!-- /.container -->
  </section>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <img src="static\front\images\client\List-of-Celebrations-Kids-Nation-1.webp" style="width: 450px; margin-right: 100px;" alt="Image" />
        </div>
      </div>
    </div>
  </div>
