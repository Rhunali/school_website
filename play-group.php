...
<head>
  ...
  <title>Kids Nation Play Group: Early Childhood Development Programs</title>

  <meta name="description" content=" Play Group curriculumn provides high-quality early childhood development programs for children ages 1-6. Our programs are designed to foster social, 
emotional, cognitive, and physical development through play-based learning  ">
  <meta name="keywords" content="
play group, preschool, curriculumn, play school, syllabus
 ">
  <meta name="robots" content="index, follow" />
  <link rel="canonical" href="play-group.php" />
  ...
  <section class="page-header bg_img" data-background="static/front/images/banner/page-header.png">
    <div class="container">
      <div class="page-header-content">
        <h1 class="title">Curriculum Play Group</h1>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-md-8 col-md-offset-2 col-12">
          ...
          <h4>LANGUAGE</h4>
          <ul>
            <li>Letters: A to Z – recognition</li>
            <li>Name one object beginning with each letter</li>
            <li>Writing: Patterns</li>
          </ul>
          <h4>MATH</h4>
          <ul>
            <li>Up and down, far and near, big and small, in and out</li>
            <li>Number value : 1 to 9</li>
            <li>Shapes – Circle, square, star and triangle</li>
          </ul>
